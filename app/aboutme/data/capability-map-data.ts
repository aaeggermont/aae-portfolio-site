  ...
  domains: [
    ...
    },
    {
      ...
      skills: [
        ...
        { id: "typescript", label: "TypeScript", order: 2 },
        { id: "java-spring", label: "Java / Spring Boot", order: 3 },
        { id: "firebase-cloud", label: "Firebase / Cloud", order: 4 },
        { id: "apis-integrations", label: "APIs & Integrations", order: 5 },
        { id: "enterprise-apps", label: "Enterprise Applications", order: 6 },
      ],
    },
    {
      id: "strategy-leadership",
      label: "Strategy, Leadership & Communication",
      ...
      skills: [
        ...
        { id: "stakeholder-mgmt", label: "Stakeholder Management", order: 2 },
        { id: "workshops", label: "Workshops & Facilitation", order: 3 },
        { id: "storytelling", label: "Storytelling & Communication", order: 4 },
      ],
    },
    {
      ...
      skills: [
        ...
        { id: "prototyping-testing", label: "Prototyping & Testing", order: 4 },
      ],
    },
    {
      id: "data-analytics",
      ...
      skills: [
        ...
        { id: "data-modeling", label: "Data Modeling & Architecture", order: 4 },
      ],
    },
  ],
};
